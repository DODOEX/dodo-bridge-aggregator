...
import { BuildTransactionDataResponse, CreateOrderResponse, CrossChainParamsData, HealthResponse, RouteResponse, StatusResponse, TokenListResponse } from "./types"
import { getData } from "./utils/utils"

export * from "./types/index";
export * from "./bridge/index";

export async function getRoute(bridgeName: string, crossChainParamsData: CrossChainParamsData & { [key: string]: any }) {
...
export async function buildTransactionData(bridgeName: string, crossChainParamsData: CrossChainParamsData & { [key: string]: any }, interfaceParamData?: { [key: string]: any }) {
    const config = await getBridgeConfig(bridgeName, true);
...
export async function getStatus(bridgeName: string, crossChainParamsData: CrossChainParamsData & { [key: string]: any }, interfaceParamData?: { [key: string]: any }) {
...
export async function getTokenList(bridgeName: string, crossChainParamsData: CrossChainParamsData & { [key: string]: any }, interfaceParamData?: { [key: string]: any }) {
    const config = await getBridgeConfig(bridgeName, true);
    return getData<TokenListResponse>(crossChainParamsData, config.apiInterface.tokenList, interfaceParamData);
}

export async function createOrder(bridgeName: string, crossChainParamsData: CrossChainParamsData & { [key: string]: any }, interfaceParamData?: { [key: string]: any }) {
    const config = await getBridgeConfig(bridgeName, true);
...
export async function health(bridgeName: string, crossChainParamsData: CrossChainParamsData & { [key: string]: any }, interfaceParamData?: { [key: string]: any }) {
    const config = await getBridgeConfig(bridgeName, true);
